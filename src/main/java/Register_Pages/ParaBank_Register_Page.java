...
public class ParaBank_Register_Page {
    ...
    private By customer_firstName()  { return By.id("customer.firstName");}
    private By customer_lastName(){ return By.id("customer.lastName");}
    private By customer_address_street() { return By.id("customer.address.street");}
    private By customer_address_city(){return By.id("customer.address.city");}
    private By customer_address_state(){return By.id("customer.address.state");}
    private By customer_address_zipCode() { return By.id("customer.address.zipCode");}
    private By customer_phoneNumber(){ return By.id("customer.phoneNumber");}
    private By customer_ssn () {return By.id("customer.ssn");}
    private By customer_username (){ return By.id("customer.username");}
    private By customer_password(){ return By.id("customer.password");}
    private By repeatedPassword (){ return By.id("repeatedPassword");}
    private By submit_Register(){ return By.xpath("//input[@value='Register']");}
